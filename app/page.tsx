            ...
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
               <h1 className="text-3xl font-bold tracking-tighter text-pink-800 sm:text-5xl xl:text-6xl/none">
                Home-Baked Treats, Freshly Crafted with
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                ...
                {/* Star Badge */}
                <div className="absolute bottom-2 left-2 rounded-full bg-white p-2 shadow-lg z-10">
                  <Star className="h-6 w-6 text-yellow-400 sm:h-7 sm:w-7 md:h-8 md:w-8" />
                </div>
               </div>
      ...
      <section id="contact" className="w-full bg-pink-50 py-12 md:py-24 lg:py-32">
        <div className="container grid gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-12">
          <div className="space-y-4">
           <h2 className="text-3xl font-bold tracking-tighter text-pink-800 sm:text-5xl text-center md:text-left">
              Get in Touch </h2>
